...
CALL sp_create_contact(1, '3216549870', 'María');

-- Crear contacto con el número de Carlos
CALL sp_create_contact(2, '7894561230', 'Carlos');

-- Crear contacto con número inexistente (debería insertarlo igual, aunque no cree chat)
CALL sp_create_contact(3, '0001112222', 'Desconocido');

-- Buscar el ID del contacto creado (opcional)
SELECT * FROM contact WHERE id_user = 1;
